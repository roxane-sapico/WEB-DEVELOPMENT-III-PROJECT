      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Roxane Sapico</span>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
  <a id="logout-link" class="dropdown-item d-flex align-items-center" href="logout.php">
...
<script>
  document.getElementById('logout-link').addEventListener('click', function (e) {
    ...
    if (confirmLogout) {
      // If "OK" is clicked, redirect to index.html
      window.location.href = "../index.html"; // Replace with your desired logout URL
    }
    // If "Cancel" is clicked, nothing happens, and the user remains on the current page.
  });
</script>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="bargraph.php">
              <i class="bi bi-circle"></i><span>Bar Graph</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="piechart.php">
              <i class="bi bi-circle"></i><span>Pie Chart of Gender</span>
            </a>
          </li>
        </ul>
      </li><!-- End Charts Nav -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Bar Graph <span>/Today</span></h5>
    ...
    <br>
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">List of Users <span>| Today</span></h5>
        ...
        <div class="col-lg-4">
          ...
          <!-- Website Traffic -->
            <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
            <div class="card-body pb-0">
              <h5 class="card-title">Pie Chart of Gender</h5>
</head>
<body>
